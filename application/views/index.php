    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            <img src="<?= base_url('assets/img/doctor1.jpg') ?>" alt="..." class="team-img">
            <div class="caption">
              <h3>Jessica Wally</h3>
              <p>Doctor</p>
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            <img src="<?= base_url('assets/img/doctor2.jpg') ?>" alt="..." class="team-img">
            <div class="caption">
              <h3>Iai Donas</h3>
              <p>Doctor</p>
              <ul class="list-inline">
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            <img src="<?= base_url('assets/img/doctor3.jpg') ?>" alt="..." class="team-img">
            <div class="caption">
              <h3>Amanda Denyl</h3>
              <p>Doctor</p>
              <ul class="list-inline">
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            <img src="<?= base_url('assets/img/doctor4.jpg') ?>" alt="..." class="team-img">
            <div class="caption">
              <h3>Jason Davis</h3>
              <p>Doctor</p>
              <ul class="list-inline">
